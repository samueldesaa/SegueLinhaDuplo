...
int tempoCurvaEsquerda = 600;

int tempoFrenteAntesCurvaDireita = 300;
int tempoCurvaDireita = 600;

int tempoCurvaVolta = 1300;
...
const char* MQTT_CLIENT_ID = "robo2_esp32_franciele";

const char* TOPICO_COMANDOS = "robos/robo2/comandos";
const char* TOPICO_STATUS = "robos/robo2/status";
const char* MENSAGEM_AGUARDANDO = "Franciele conectada e aguardando rota";
...
void re() {
  setVelocidade(velocidade+20, velocidade);
